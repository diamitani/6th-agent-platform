...
export default function BrandPage() {
  const colors = [
    { name: "Champion Orange", hex: "#C96442", rgb: "rgb(255,107,0)" },
    ...
    { name: "Charcoal", hex: "#262624", rgb: "rgb(26,26,26)" },
    { name: "Gold", hex: "#B08324", rgb: "rgb(245,193,0)" },
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border bg-card p-8 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 160" width="400" height="107">
                <defs><linearGradient id="rg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#C96442"/><stop offset="50%" stopColor="#FF8C00"/><stop offset="100%" stopColor="#E85D00"/></linearGradient></defs>
                <g transform="translate(5,5)scale(0.37)"><circle cx="200" cy="200" r="150" fill="#C96442" opacity="0.04"/><path d="M 200 55 C 280 55 345 120 345 200 C 345 280 280 345 200 345 C 120 345 55 280 55 200 C 55 120 120 55 200 55 Z" fill="none" stroke="url(#rg)" strokeWidth="24" strokeLinecap="round"/><path d="M 320 260 C 305 310 265 340 200 345" fill="none" stroke="url(#rg)" strokeWidth="24" strokeLinecap="round"/><polygon points="200,140 158,260 200,238 242,260" fill="#262624" stroke="#C96442" strokeWidth="2" strokeOpacity="0.25"/><line x1="175" y1="232" x2="225" y2="232" stroke="#262624" strokeWidth="5" strokeLinecap="round"/><ellipse cx="178" cy="178" rx="8" ry="5" fill="#C96442" opacity="0.35" transform="rotate(-30 178 178)"/></g>
                <text x="230" y="52" fontFamily="Inter,sans-serif" fontSize="52" fontWeight="800" fill="#262624" letterSpacing="-1.5">6<tspan fontSize="36" fontWeight="700" fill="#C96442" letterSpacing="-0.5">th</tspan></text>
                <text x="230" y="97" fontFamily="Inter,sans-serif" fontSize="40" fontWeight="300" fill="#57564F" letterSpacing="6">AGENT</text>
                <text x="232" y="122" fontFamily="Inter,sans-serif" fontSize="11" fontWeight="500" fill="#C96442" letterSpacing="4">YOUR SIXTH MAN</text>
              </svg>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={t.tag} className="rounded-xl border bg-card p-5">
                <p className={`font-heading font-bold ${t.size}`} style={{ color: t.tag === "Your sixth man." ? "#C96442" : "#262624" }}>{t.tag}</p>
        ...
        <section className="mb-16">
          ...
          <div className="rounded-2xl border bg-card p-8 text-lg leading-relaxed space-y-4 italic text-muted-foreground">
            <p><span className="text-4xl font-heading text-[#C96442]">"</span>Every great team has one. Not the MVP. Not the starter. The one who comes off the bench and changes everything.</p>
            ...
            <p className="font-heading text-2xl not-italic font-bold text-[#C96442]">6thAgent — Your sixth man.</p>
          </div>
        </section>
